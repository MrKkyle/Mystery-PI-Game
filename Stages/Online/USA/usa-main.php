...
<html lang="en">
	...
	<body>
            ...
            <div class = "background-image">
                <div class = "d-selection" id = "d-select">
                    ...
                    <div class = "d-elements Easy" onclick = "startTimer(300);">
                        <div class = "text" style = "color: aliceblue;">USA - Easy</div>
                        <div class = "d-text-bg"></div>
                    </div>
                    <div class = "d-elements Medium" onclick = "startTimer(180);">
                        <div class = "text" style = "color: aliceblue;">USA - Medium</div>
                        <div class = "d-text-bg"></div>
                    </div>
                    <div class = "d-elements Hard" onclick = "startTimer(120);"> 
                        <div class = "text" style = "color: aliceblue;">USA - Hard</div>
                        <div class = "d-text-bg"></div>
                    </div>
        ...
        <div class = "message-2" id = "message-2">
            ...
            <br><br>
            <button class = "button" onclick = "window.location.href = 'usa-main.php';">Proceed</button>
        </div>
