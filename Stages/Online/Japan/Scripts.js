...
/* Script for the form fields */
let _name = document.getElementById("name");
let time = document.getElementById("time");
let message2 = document.getElementById("message-2");
let base_timer = document.getElementById("base-timer-label");

/* Set the images  */ 
Image1 = "../../../Media/Stages/jp1.jpg";
Image2 = "../../../Media/Stages/jp2.jpg";
Image3 = "../../../Media/Stages/jp3.jpg";
        ...
        img[i].addEventListener("click", () =>
        {
            for(let z = 0; z < li.length; z++)
            {
                ...
                if(count >= 15)
                {
                    ...
                    time.value = formatTime(timeLeft);
